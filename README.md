...
| 브랜치 | 파일 | 담당 |
|---|---|---|
| `index` | `index/index.html` | 온보딩 (스크롤 인트로) |
| `dashboard` | `dashboard/dashboard.html` | 현황 대시보드 |
| `pattern` | `pattern/pattern.html` | 패턴 분석 |
| `simulator` | `simulator/simulator.html` | 시뮬레이터 (과거 매수 시점 체험 + 리스크체크리스트/계산기/퀴즈) |
