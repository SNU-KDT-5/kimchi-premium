...
**기획**: 환율을 고려했을 때 현재 김프의 실질 수익률이 얼마인지 보여주는 페이지.
핵심 지표(환율/김프) → 더 자세히 알아보기(경제 상황 지표, 항목 미정) → 프리미엄만큼
벌었다면 vs 실제로 번 것(평상시 사례만) → 김프의 상대 가격 2년치(게이지/히트맵)
순서. 지금 구현이 이 기획과 대체로 일치합니다.
...
- ①의 "더 알아보기" 아코디언 안에 USDT 거래량/거래대금/네이버 검색지수 등 실제 지표 채우기
